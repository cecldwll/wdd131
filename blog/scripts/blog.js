// Define the articles array first
const articles = [
  {
    id: 1,
...
// Reference to the bookshelf div
...
function displayArticles(articles) {
  articles.forEach(article => {
    ...
    // Template literal for the article's HTML content
    const articleHTML = `
    ...
    // Append the new article to the bookshelf
    bookshelf.appendChild(newArticle);
  });
}
